...
const Projects = () => {
    ...
    const currProject = myProjects[currIndex]
    ...
    return (
        <section className="c-space my-20" id="work">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
                <div className=" bg-black flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl
                shadow-black-200 rounded-xl">
                    <div className="absolute top-0 right-0">
                        <img src={myProjects[0].spotlight}  alt="spotlight" className="w-full h-96 object-cover rounded-xl"/>
                    </div>
                    <div className="p-3 backdrop-blur-3xl backdrop-filter w-fit rounded-lg"
                        ...
                        <Center>
                            <Suspense fallback={<CanvasLoader />}>
                                <group scale={2} position={[0, -3, 0]} rotation={[0, -0.1, 0]}>
                                    <DemoComputer textture={currProject.texture}/>
                                </group>
                            </Suspense>
                        </Center>
